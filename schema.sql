...
CREATE TABLE IF NOT EXISTS forum_threads (
  ...
  category TEXT DEFAULT 'general', -- 'general', 'git', 'frontend', 'javascript', 'python', 'react', 'backend'
  status TEXT DEFAULT 'open', -- 'open', 'pinned', 'closed'
...
-- Índices para el foro (paginación rápida con muchos hilos)
...
-- Contador desnormalizado de respuestas (evita COUNT(*) en listados)
